        ...
        for serif_stroke in self.serif_strokes:
            ...
            if stroke.a1_100 == 0: # None
                ...
                if stroke.a3_100 == 4 and stroke.a3_opt_2 == 0: # and serif_stroke.hane_adjustment == 0 # left hook, 左撥ね上げ
                    ...
                    stroke_drawer.DrawLine(stroke.vec_1, vec_t, stroke.a2_100, 1)
                    stroke_drawer.DrawCurve(vec_t, stroke.vec_2, stroke.vec_2 - Vec2(self.kMage * 2, self.kMage * 0.5), 1, 0, False, True)
                else: # other shapes
                    stroke_drawer.DrawLine(stroke.vec_1, stroke.vec_2, stroke.a2_100, stroke.a3_100)
                ...
                if stroke.a3_100 == 4 and stroke.a3_opt_2 == 0: # and serif_stroke.hane_adjustment == 0 # left hook, 左撥ね上げ
                    ...
                    stroke_drawer.DrawCurve(stroke.vec_1, stroke.vec_2, vec_t, stroke.a2_100, 1)
                    stroke_drawer.DrawCurve(vec_t, stroke.vec_3, stroke.vec_3 - Vec2(self.kMage * 2, self.kMage * 0.5), 1, 0, False, True)
                    ...
                    stroke_drawer.DrawCurve(stroke.vec_1, stroke.vec_2, stroke.vec_3, stroke.a2_100, 1)
                    stroke_drawer.DrawCurve(stroke.vec_3, vec_t1, vec_t2, 1, 0, False, True)
                ...
                #     stroke_drawer.DrawLine(stroke.vec_1, stroke.vec_3, 1, 0)
                    ...
                    stroke_drawer.DrawCurve(stroke.vec_1, stroke.vec_2, stroke.vec_3, stroke.a2_100, stroke.a3_100)
                ...
                stroke_drawer.DrawLine(stroke.vec_1, vec_t1, stroke.a2_100, 1)
                stroke_drawer.DrawCurve(vec_t1, stroke.vec_2, vec_t2, 1, 1, False, True)
                ...
                if stroke.a3_100 == 5 and stroke.a3_opt_1 == 0 and serif_stroke.mage_adjustment == 0: # right hook, 右撥ね上げ 
                    ...
                    stroke_drawer.DrawLine(vec_t2, vec_t3, 1, 1, True)
                    stroke_drawer.DrawCurve(vec_t3, stroke.vec_3, vec_t4, 1, 0, False, True)
                else: # other shapes
                    stroke_drawer.DrawLine(vec_t2, stroke.vec_3, 1, stroke.a3_100, True)
                ...
                if stroke.a3_100 == 4: # left hook
                    ...
                    stroke_drawer.DrawCurve(vec_t1, stroke.vec_4, vec_t2, 1, 0, False, True)
                else: # others
                    stroke_drawer.DrawBezier(stroke.vec_1, stroke.vec_2, stroke.vec_3, stroke.vec_4, stroke.a2_100, stroke.a3_100)
            elif stroke.a1_100 == 7: # 縦払い（3 座標:始点, 経由点, 制御点, 終点）, vertical slash
                stroke_drawer.DrawLine(stroke.vec_1, stroke.vec_2, stroke.a2_100, 1)
                stroke_drawer.DrawCurve(stroke.vec_2, stroke.vec_3, stroke.vec_4, 1, stroke.a3_100, False, True)
            else:
                pass