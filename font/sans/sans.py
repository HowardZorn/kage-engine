        ...
        for serif_stroke in self.serif_strokes:
            ...
            if stroke.a1_100 == 0: # None
                ...
                if stroke.a3_100 == 4 and stroke.a3_opt_2 == 0: # and serif_stroke.hane_adjustment == 0 # left hook, 左撥ね上げ
                    ...
                    SansStrokeDrawer.DrawCurve(self, canvas, vec_t, stroke.vec_3, stroke.vec_3 - Vec2(self.kMage * 2, self.kMage * 0.5), 1, 0, False, True)
                    ...
                    SansStrokeDrawer.DrawCurve(self, canvas, stroke.vec_3, vec_t1, vec_t2, 1, 0, False, True)
                elif stroke.a2_100 == 7 and stroke.a3_100 == 8: # 點
                    SansStrokeDrawer.DrawLine(self, canvas, stroke.vec_1, stroke.vec_3, 1, 0)
                else: # other shapes
                ...
                SansStrokeDrawer.DrawCurve(self, canvas, vec_t1, stroke.vec_2, vec_t2, 1, 1, False, True)
                ...
                if stroke.a3_100 == 5 and stroke.a3_opt_1 == 0 and serif_stroke.mage_adjustment == 0: # right hook, 右撥ね上げ 
                    ...
                    SansStrokeDrawer.DrawLine(self, canvas, vec_t2, vec_t3, 1, 1, True)
                    SansStrokeDrawer.DrawCurve(self, canvas, vec_t3, stroke.vec_3, vec_t4, 1, 0, False, True)
                else: # other shapes
                    SansStrokeDrawer.DrawLine(self, canvas, vec_t2, stroke.vec_3, 1, stroke.a3_100, True)
                ...
                if stroke.a3_100 == 4: # left hook
                    ...
                    SansStrokeDrawer.DrawBezier(self, canvas, stroke.vec_1, stroke.vec_2, stroke.vec_3, vec_t, stroke.a2_100, 1)
                    SansStrokeDrawer.DrawCurve(self, canvas, vec_t, stroke.vec_4, stroke.vec_4 - Vec2(self.kMage * 2, self.kMage * 0.5), 1, 0, False, True)
                    ...
                    SansStrokeDrawer.DrawCurve(self, canvas, vec_t1, stroke.vec_4, vec_t2, 1, 0, False, True)
                else: # others
                ...
                SansStrokeDrawer.DrawCurve(self, canvas, stroke.vec_2, stroke.vec_3, stroke.vec_4, 1, stroke.a3_100, False, True)
            else:
                pass