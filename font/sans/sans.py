    ...
    def draw_stroke(self, canvas: svgwrite.Drawing):
        for serif_stroke in self.serif_strokes:
            ...
            if stroke.a1_100 == 0:
                ...
                if stroke.a3_100 == 4 and stroke.a3_opt_2 == 0: # and serif_stroke.hane_adjustment == 0
                ...
                if stroke.a3_100 == 4:
                    ...
                    SansStrokeDrawer.DrawCurve(self, canvas, vec_t, stroke.vec_4, stroke.vec_4 - Vec2(self.kMage * 2, self.kMage * 0.5), 1, 0)
                elif stroke.a3_100 == 5 and stroke.a3_opt == 0:
